package com.mariosmant.webapp.mediahub.common.web.rate.limiter.token.bucket.infrastructure.spring;

import com.mariosmant.webapp.mediahub.common.web.rate.limiter.domain.RateLimiter;
import com.mariosmant.webapp.mediahub.common.web.rate.limiter.token.bucket.domain.TokenBucketRateLimiter;
