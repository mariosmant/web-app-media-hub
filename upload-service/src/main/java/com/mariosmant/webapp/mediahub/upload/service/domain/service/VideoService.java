...
public class VideoService {
    ...
    public VideoService(AuditLogPort audit, CacheManager cacheManager) {
        this.audit = audit;
        this.cacheManager = Objects.requireNonNull(cacheManager);
    }

    @Transactional
    public String videoUpload(UploadVideoRequest uploadVideoRequest, Map<String, List<MultipartFile>> files) {
