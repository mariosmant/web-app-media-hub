package com.mariosmant.webapp.mediahub.common.web.util;

import jakarta.servlet.http.HttpServletRequest;

import java.util.List;

// TODO Move to another module non spring specific. Keep extraction of IP and headers here and move the logic to a plain Java module.
